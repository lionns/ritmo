...
| [T-011](docs/tasks/T-011-off-cloudflare-onto-node-and-sqlite.md) | `doing` | Move the runtime, the store, the adapter and the gates from Cloudflare to Node and |
...
**T-011** (`doing`) — Move the runtime, the store, the adapter and the gates from Cloudflare to Node and
