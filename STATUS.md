...
| [T-007](docs/tasks/T-007-next-action-invariant.md) | `doing` | Make the "exactly one open next action" invariant something the rules enforce rather than |
...
**T-007** (`doing`) — Make the "exactly one open next action" invariant something the rules enforce rather than
