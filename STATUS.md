...
| [T-015](docs/tasks/T-015-errors-that-point-and-a-listbox-of-our-own.md) | `doing` | Give every form one error treatment that names the field it belongs to, and replace both |
...
**T-015** (`doing`) — Give every form one error treatment that names the field it belongs to, and replace both
