...
| [T-006](docs/tasks/T-006-first-loop-front.md) | `ready` | Build the landing surface and the log form from the approved design, against the endpoints |
| [T-005](docs/tasks/T-005-first-loop-back.md) | `review` | Give the front two endpoints and the contracts behind them, so a real portfolio can be read |
...
**T-005** (`review`) — Give the front two endpoints and the contracts behind them, so a real portfolio can be read
