...
| [T-006](docs/tasks/T-006-first-loop-front.md) | `doing` | Build the landing surface and the log form from the approved design, against the endpoints |
...
**T-006** (`doing`) — Build the landing surface and the log form from the approved design, against the endpoints
