...
| [T-014](docs/tasks/T-014-creation-moves-to-the-structure-screen.md) | `review` | Move project creation out of the portfolio card and into `/ajustes`, split that screen into |
...
**T-014** (`review`) — Move project creation out of the portfolio card and into `/ajustes`, split that screen into
