...
| [T-008](docs/tasks/T-008-log-form-minutes-and-context.md) | `doing` | Give `/registrar` the three things the approved artboard has and the screen does not — optional |
...
**T-008** (`doing`) — Give `/registrar` the three things the approved artboard has and the screen does not — optional
