/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 096ed68b0a54ba3c4b8d5769bbad0102)
// Runtime types generated with workerd@1.20260921.1 2026-09-22 nodejs_compat
interface __BaseEnv_Env {
	RITMO_STORE: string;
	RITMO_DATABASE_URL: string;
	RITMO_DATABASE_TOKEN: string;
	RITMO_SESSION_SECRET: string;
	RITMO_PASSWORD_HASH: string;
	RITMO_OWNER_ID: string;
	RITMO_AUTH_ORIGIN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RITMO_STORE" | "RITMO_DATABASE_URL" | "RITMO_DATABASE_TOKEN" | "RITMO_SESSION_SECRET" | "RITMO_PASSWORD_HASH" | "RITMO_OWNER_ID" | "RITMO_AUTH_ORIGIN">> {}
}
